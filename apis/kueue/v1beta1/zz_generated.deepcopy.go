...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynamicResourceMapping) DeepCopyInto(out *DynamicResourceMapping) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamicResourceMapping.
func (in *DynamicResourceMapping) DeepCopy() *DynamicResourceMapping {
	if in == nil {
		return nil
	}
	out := new(DynamicResourceMapping)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceFlavorSpec) DeepCopyInto(out *ResourceFlavorSpec) {
	*out = *in
	...
	if in.DynamicResources != nil {
		in, out := &in.DynamicResources, &out.DynamicResources
		*out = make([]DynamicResourceMapping, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
